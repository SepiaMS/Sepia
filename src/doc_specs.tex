...
%    Updated: 2016/03/24 22:58:36 by aguellil         ###   ########.fr        %
%                                                                              %
%******************************************************************************%
...
\begin{itemize}
    ...
    \item Signe de Lhermitte positif (sensation de décharge électrique parcourant le rachis et les jambes lors de la flexion de la colonne cervicale)
\end{itemize}
\subsubsection{Génitaux}
\begin{itemize}
    \item Difficultés urinaires
    \item Constipation
    \item Impuissance
\end{itemize}
\subsubsection{Auditifs}
\begin{itemize}
	\item Hyperacousie
\end{itemize}
